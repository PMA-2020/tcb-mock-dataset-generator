"""Create new PMA TCB Personnel dataset
...
from config import SKILL_FIELD_REPEATS, SKILL_DATA_FIELDS, SKILLS
...
HEADER: List[str] = [x for x in COMPOSITE_ID_FIELDS] + SKILL_DATA_FIELDS
